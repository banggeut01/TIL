...
function getDataPromise() {
    return new Promise(resolve => { // Promise object 리턴
        setTimeout(function() {
            console.log('요청을 보냈습니다.')
            const data = {'data': 'some data'} // 데이터 도착
...
console.log(promise2) // reject 함수를 호출 하기 때문에 (rejected)

promise1.then(response => console.log(response)) // resolved는 then
promise2.catch(error => console.log(error)) // rejected는 catch
